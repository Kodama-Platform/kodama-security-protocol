# @kodama.page/ksp-browser

Browser helpers for the Kodama Security Protocol. Re-exports all of `@kodama.page/ksp-core` plus URL fragment utilities for read-only sharing.

## Install

```bash
npm install @kodama.page/ksp-browser
```
...
```typescript
import { getFragmentCapability } from "@kodama.page/ksp-browser";
